export const favoriteList = "Favorite Asteroids";
...
export interface InitialState {
  asteroids: Asteroids;
  sortedByName: Asteroids;
  searchByName: Asteroids;
  favorites: { links: AsteroidsLinks; element_count: number; near_earth_objects: { [key: string]: NearEarthObject[] } };
  loading: boolean;
}
